...
(eval-and-compile
  (defconst masm-directives
    '("alias" "align" "assume" "catstr" "comm" "comment" "db" "dd"
    "df" "dosseg" "dq" "dt" "dup" "dw" "echo" "else" "elseif"
    "elseif1" "elseif2" "elseifb" "elseifdef" "elseifdif" "elseifdifi"
    "elseife" "elseifidn" "elseifidni" "elseifnb" "elseifndef" "end"
    "endif" "endm" "endp" "ends" "eq" "equ" "even" "exitm" "extern"
    "externdef" "extrn" "for" "forc""ge" "goto" "group" "gt" "high"
    "highword" "if" "if1" "if2" "ifb" "ifdef" "ifdif" "ifdifi" "ife"
    "ifidn" "ifidni" "ifnb" "ifndef" "include" "includelib" "instr"
    "irp" "irpc" "label" "le" "length" "lengthof" "local" "low"
    "lowword" "lroffset" "lt" "macro" "mask" "mod" "name" "ne"
    "offset" "opattr" "option" "org" "page" "popcontext" "proc"
    "proto" "ptr" "public" "purge" "pushcontext" "record" "repeat"
    "rept" "seg" "segment" "short" "size" "sizeof" "sizestr" "struc"
    "struct" "substr" "subtitle" "subttl" "textequ" "this" "title"
    "type" "typedef" "union" "while")
...
(defconst masm-font-lock-keywords
  `((,(masm--opt masm-section-name) . 'masm-section-name)
    ...
    (,(masm--opt masm-instructions) . 'masm-instructions)
    ...
    (,(masm--opt masm-directives) . 'masm-directives))
  "Keywords for `masm-mode'.")
